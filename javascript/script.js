// const question=document.querySelector("button");
// const para=document.querySelector("p");
// question.addEventListener("click", ()=>{
//    question.classList.toggle("response");
//    para.style.visibility="visible";
   
// })
const answ1=document.querySelector(".answ1")
...
answer10.classList.toggle("ans4");
});
...
answer11.classList.toggle("ans4");
});
...
answer12.classList.toggle("ans4");
});
...
answer13.classList.toggle("ans4");
});
...
answer14.classList.toggle("ans4");
});
...
answer15.classList.toggle("ans4");
});
...
answer16.classList.toggle("ans4");
});
...
answer17.classList.toggle("ans4");
});
...
answer18.classList.toggle("ans4");
});
...
answer19.classList.toggle("ans4");
});
...
answer20.classList.toggle("ans4");
});
...
answer21.classList.toggle("ans4");
});
...
answer22.classList.toggle("ans4");
});
...
answer23.classList.toggle("ans4");
});
...
answer24.classList.toggle("ans4");
});
